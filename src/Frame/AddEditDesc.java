...
public class AddEditDesc extends JFrame {
	...
	/** Create the frame. **/
	public AddEditDesc(Describe d, ViewFrame vf) {
		...
		// TODO set combobox with databas data. -> get by combobox index;
		...
		// TODO set combobox with databas data.
